var I=Object.defineProperty;var S=(r,t,e)=>t in r?I(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var b=(r,t,e)=>S(r,typeof t!="symbol"?t+"":t,e);import{A as $}from"./index-Dg3wt9U-.js";class H extends ${constructor(){super(...arguments);b(this,"baseURL","https://api.openai.com/v1")}async generateCode(e,n){var l,d,m,y;try{const o=e.apiKey||this.apiKey;if(!o)throw new Error("API密钥未提供");const f=`
